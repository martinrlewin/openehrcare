package com.inidus.platform.fhir.patient;
 ...
 */
@Component("PatientResourceProvider")
public class PatientResourceProvider implements IResourceProvider {
   ...
   public PatientResourceProvider() {
      ...
      patient.setId("3e674739-950c-4b8a-976b-5aef21c618c5");
      patient.addIdentifier();
      patient.getIdentifier().get(0).setSystem("uk.nhs.nhs_number");
      patient.getIdentifier().get(0).setValue("9999999000");
      patient.addName().setFamily("Smith");
      patient.getName().get(0).addGiven("Derek");
      patient.getName().get(0).addPrefix("Mr");
      patient.getName().get(0).addSuffix("MBE");
      patient.addTelecom();
      patient.getTelecom().get(0).setSystem(ContactPoint.ContactPointSystem.PHONE);
      patient.getTelecom().get(0).setValue("0113 2960587");
      patient.getTelecom().get(0).setUse(ContactPoint.ContactPointUse.WORK);
      patient.addAddress();
      patient.getAddress().get(0).setUse(Address.AddressUse.HOME);
      patient.getAddress().get(0).setPostalCode("LS1 6AE");
      patient.getAddress().get(0).addLine("1 Trevelyan Square").addLineElement().setValue("Boar Lane");
      patient.getAddress().get(0).getLine().add(new StringType("City Centre"));
      patient.getAddress().get(0).getLine().add(new StringType("Leeds"));
      patient.getAddress().get(0).getLine().add(new StringType("West Yorkshire"));
   ...
   public Patient readPatient(@IdParam IdType theId) {
      ...
      try {
         Long id;
         if (theId.getIdPart().equals("3e674739-950c-4b8a-976b-5aef21c618c5")) {
            id = 1L;
         } else {
            id = theId.getIdPartAsLong();
         }

         retVal = myIdToPatientVersions.get(id);
